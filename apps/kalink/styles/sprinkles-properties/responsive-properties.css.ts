...
const alignContentValues = ['start', 'end', 'center'] as const;
const justifySelfValues = ['start', 'end', 'center'] as const;
...
interface DividedStyle {
  vars: Record<typeof dividedSpace, string>;
}
...
export const responsiveProperties = defineProperties({
  ...
  properties: {
    ...
    width: widthStyles,
    height: heightStyles,
    maxInlineSize: maxInlineSizeStyles,
    ...
    divided: dividedValues.reduce<
      Partial<Record<(typeof dividedValues)[number], DividedStyle>>
    >(
      (acc, value) => ({
        ...acc,
        [value]: {
...
export type WidthValues = keyof typeof widthStyles;
export type ResponsiveWidth = ResponsiveValue<WidthValues>;

export type HeightValues = keyof typeof heightStyles;
export type ResponsiveHeight = ResponsiveValue<HeightValues>;

export type MaxInlineSizeValues = keyof typeof maxInlineSizeStyles;
