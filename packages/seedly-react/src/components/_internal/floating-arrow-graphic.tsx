interface FloatingArrowGraphicProps {
  fillClassName: string;
  outerStrokeClassName: string;
  innerStrokeClassName: string;
}

export function FloatingArrowGraphic({
  fillClassName,
  outerStrokeClassName,
  innerStrokeClassName,
}: FloatingArrowGraphicProps) {
  return (
    <svg width="20" height="10" viewBox="0 0 20 10" fill="none">
      <path
        d="M9.66437 2.60207L4.80758 6.97318C4.07308 7.63423 3.11989 8 2.13172 8H18.5349C17.5468 8 16.5936 7.63423 15.8591 6.97318L11.0023 2.60207C10.622 2.2598 10.0447 2.25979 9.66437 2.60207Z"
